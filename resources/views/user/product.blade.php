                    ...
                    <div class="col-3 filter-col" id="filter-col">
                        ...
                        <div class="box">
                            ...
                            <ul class="filter-list">
                                <li><i class='bx bxs-chevron-left text-green'></i><a
                                        href="{{ route('user.All_Product.index') }}">جميع المنتجات</a></li>
                                <li><i class='bx bxs-chevron-left text-green'></i><a
                                        href="{{ route('user.All_Product.create') }}">العروض</a></li>

                                @foreach ($category as $item)
                                    <li><i class='bx bxs-chevron-left text-green'></i><a
                                            href="{{ route('user.All_Product.show', $item->id) }}">{{ $item->name_category }}</a>
                                    </li>
                                @endforeach
                            </ul>
                        </div>
                                        ...
                                        <div class="product-card">
                                            ...
                                            <div class="product-card-info">
                                                <div class="product-btn">
                                                    <a href="{{ route('user.single_product.show', $item->id) }}"> <button
                                                            class="btn-flat btn-hover btn-shop-now">تفاصيل</button></a>
                                                    <a>
                                                ...
                                                <div class="product-card-price">
                                                    ...
                                                    @if ($item->is_sale == 1)
                                                        @if ($item->unit == 'weight')
                                                            ...
                                                            <span class="curr-price">JD
                                                                {{ ($item->price_discount * 250) / 1000 }}</span>
                                                        @else
