        ...
        <table width="100%">
            ...
            <tbody>
              ...
              {{-- {{dd($item)}} --}}
                    ...
                    <tr>
                        <td><img src="{{ URL::asset('storage/image/' . $item['product_image']) }}" style="width: 75px ;    height: 75px" alt="{{ $item['product_image'] }}"></td>
                        <td>
                            <h5>
                                {{ $item['product_name'] }}
                            </h5>
                  ...
                  <button type="submit">تأكيد التعديل</button>
                        ...
                        {{-- _____________________ --}}
                        <td><a href="{{ route('user.cart.destroy', $item['product_id']) }}"><i class="fas fa-trash-alt"> X</i></a></td>
                        <td>
